 ...
 * @version     2.0.0
 * mods
 * Feb20 - zig add col=sm-10 to widget feed (style widget title with css) per Nate
 */
?>

<?php if ($upw_query->have_posts()) : ?>

  <div class="upw-container coe-alerts row">
    <div class="upw-title col-sm-3">
      <h3 class="widget-title m-has-ico">
        <i class="widget-ico fa fa-exclamation-triangle"></i>
        <a href="https://www.ellsworthmaine.gov/category/city-alerts/">Citywide Alerts</a>
      </h3>
    </div>
    <div class="upw-posts hfeed col-sm-9">
